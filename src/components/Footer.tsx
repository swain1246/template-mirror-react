...
const Footer = () => {
  const tweets = [
    ...
    },
    {
      ...
      name: "@movers",
      content:
        "Just completed another successful move! Our team takes pride in making relocation stress-free for our clients. Thank you for choosing us!",
      time: "~4 days ago",
    },
    {
      id: 3,
      name: "@movers",
      content:
        "Moving tip of the day: Label boxes by room and priority. This makes unpacking much easier and helps you settle into your new home faster!",
      time: "~1 week ago",
    },
  ];
  ...
  return (
    <footer className="bg-footerDark text-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://eyecix.com/html/moverspackers/extra-images/twitter-feed-img.jpg')",
        }}
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-footerDarker border border-muted/20 rounded-lg p-8 flex items-start justify-between hover:border-accent/50 transition-colors">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                PLOT NO 1530, SATYAVIHAR, rasulgarh, MANCHESWAR, BHUBANESWAR, khurdha, pin-
                751010
              </p>
            </div>
            <MapPin
          ...
          <div className="bg-footerDarker border border-muted/20 rounded-lg p-8 flex items-start justify-between hover:border-accent/50 transition-colors">
            <div>
              ...
              <p className="text-muted-foreground">+91 8249778018</p>
              <p className="text-muted-foreground">+91 8249778018</p>
            </div>
            <Phone
              className="text-accent flex-shrink-0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 py-12 border-t border-muted/20">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Lorem ipsum dolor sit amet, consectetur adipisci elit. Maecenas
              venenatis, augue nec pretiumo ante mauris congue dui, eu porttitor
              enim ip non purus ellentesque sit amet
            </p>
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Vestibulum maximus orci in ante convallis egestas Nulla a ex exet
              ex suscipit pulvinar.
            </p>
            <div className="space-y-4">
              ...
              />
              <Button className="w-full bg-transparent border-2 border-white hover:bg-accent hover:border-accent hover:text-accent-foreground transition-colors">
                Subscribe
              </Button>
            </div>
          </div>
      ...
      <div className="bg-footerDarker border-t border-muted/20 py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            <p>© 2025. All Right Reserved - by EYECIX</p>
